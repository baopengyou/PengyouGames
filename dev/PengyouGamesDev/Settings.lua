...
local function build()
  ...
  local slider = CreateFrame("Slider", "PengyouGamesDevScaleSlider", win, "OptionsSliderTemplate")
  slider:SetPoint("TOP", 0, -310)
  slider:SetSize(240, 17)
  slider:SetMinMaxValues(0.6, 1.6)
  slider:SetValueStep(0.05)
  slider:SetObeyStepOnDrag(true)
  local lowFS = _G["PengyouGamesDevScaleSliderLow"]
  local highFS = _G["PengyouGamesDevScaleSliderHigh"]
  local textFS = _G["PengyouGamesDevScaleSliderText"]
